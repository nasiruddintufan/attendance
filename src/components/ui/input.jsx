...
const Input = ({label,value,type='',className,onChange}) => {
  return (
    <div className="relative w-full group">
      ...
      <input type={type} value={value} id="input" onChange={onChange}  className={`${className} peer w-full pl-6 pr-4 pt-6 pb-2 text-sm text-gray-800 bg-white border border-gray-200 rounded-lg shadow-md focus:border-transparent focus:ring-2 focus:ring-indigo-300 focus:outline-none transition-all duration-300 delay-200 placeholder-transparent`} />
